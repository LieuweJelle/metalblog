...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Wijzigen') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', [ 'id' => $user->id ]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telephone" type="text" class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}" name="telephone" value="{{ $user->telephone }}" required>
                       ...
                       <div class="card"> 
                        ...
                        <div class="form-group"><br />
                            <textarea rows="4" cols="94" class="ta" name="intro" id="intro">{{ $user->intro }}</textarea>
                        </div>
